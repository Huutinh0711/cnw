<div class="row1 mb ">
    ...
    <div class="boxcontent formtaikhoan">
        ...
        ?>
            <form action="login.php?act=dangnhap" method="POST">
                <div class="row1 mb10 ">
                    Tên đăng nhập<br>
...
<div class="row1 ">
    ...
    <div class="boxcontent row1">
        ...
        <div class="row1 mb10 top10">
            <a href="index.php?act=sanphamct&idsp=15"><img src="views/img/ip14pro.webp" alt=""></a>
            <a href="index.php?act=sanphamct&idsp=15" class="text-center">iPhone 14 Pro Max 128GB</a>
        </div>
        <div class="row1 mb10 top10">
            <a href="index.php?act=sanphamct&idsp=14"><img src="views/img/ip13pro.webp" alt=""></a>
            <a href="index.php?act=sanphamct&idsp=14" class="text-center">iPhone 13 Pro 256GB</a>
        </div>
        <div class="row1 mb10 top10">
            <a href="index.php?act=sanphamct&idsp=12"><img src="views/img/laptopnitro5.webp" alt=""></a>
            <a href="index.php?act=sanphamct&idsp=12" class="text-center">Laptop ACER Nitro 5 Eagle</a>
        </div>
        <div class="row1 mb10 top10">
            <a href="index.php?act=sanphamct&idsp=10"><img src="views/img/dtsamsungs21.webp" alt=""></a>
            <a href="index.php?act=sanphamct&idsp=10" class="text-center">Samsung Galaxy S21+ 5G</a>
        </div>
        <div class="row1 mb10 top10">
            <a href="index.php?act=sanphamct&idsp=9"><img src="views/img/taingheoverear.webp" alt=""></a>
